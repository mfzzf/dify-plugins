...
from tools._payloads import build_music_video_fields
...
class VideoToMusicTool(Tool):
    def _invoke(
        ...
        fields = build_music_video_fields(video_url=video_url, prompt=prompt, output_format=output_format)
